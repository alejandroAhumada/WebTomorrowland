...
export const categoryLabels: Record<PlanCategory, string> = { GLOBAL_JOURNEY: 'Global Journey', SEPARATE_PURCHASE: 'Entrada y viaje por separado', UNKNOWN: 'Información pendiente' }
