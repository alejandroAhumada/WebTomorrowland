...
export function PlansPage({ travelerCount }: { travelerCount: 1 | 2 }) {
  ...
  return <div className="page-container plans-page">
    <div className="page-heading"><div><p className="eyebrow">Explorar alternativas</p><h1>Plan {travelerCount} {travelerCount === 1 ? 'persona' : 'personas'}</h1><p>Todos los valores actuales son estimaciones demo en pesos chilenos.</p></div><Link className="switch-link" to={travelerCount === 1 ? '/planes/2-personas' : '/planes/1-persona'}>Ver plan para {travelerCount === 1 ? '2 personas' : '1 persona'} →</Link></div>
