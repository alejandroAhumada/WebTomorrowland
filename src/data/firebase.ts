...
export function getFirebaseDb(): Firestore {
  if (!app) {
    ...
    if (!config.apiKey || !config.projectId || !config.appId) throw new Error('Falta configuración Firebase. Usa VITE_DATA_SOURCE=demo o completa las variables VITE_FIREBASE_*.')
