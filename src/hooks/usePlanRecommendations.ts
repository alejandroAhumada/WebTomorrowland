...
export function usePlanRecommendations(travelerCount: 1 | 2, excludedPlanIds: readonly string[] = []) {
  ...
  const recommendations = useMemo(() => {
    ...
    return createPlanRecommendations(plans, budgets, travelerCount, excludedPlanIds)
  }, [plans, preferences, rate, travelerCount, excludedPlanIds])
